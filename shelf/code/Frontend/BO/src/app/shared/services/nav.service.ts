...
export class NavService implements OnDestroy {
  ...
  MENUITEMS: Menu[] = [
    ...
    //   type: 'sub',
    //   active: false,
    //   accessList: [AccessList.View_User_List],
    //   children: [
    //     {
    //       path: '/dashboard/user-management',
    //       title: 'User Management',
    //       type: 'link',
    //       accessId: AccessList.View_User_List
    //     },
    //     {
    //       path: '/dashboard/user-group',
    //       title: 'User Group',
    //       type: 'link',
    //       accessId: AccessList.View_User_Group
    //     }
    //   ],
    // },
    {
      title: 'Mystery Packet',
      icon: 'slack',
      type: 'sub',
      active: true,
      accessList: [AccessList.View_User_List], // Need to change
      children: [
        {
          path: '/dashboard/promotion-dashboard',
          title: 'Dashboard',
          type: 'link',
          accessId: AccessList.View_User_List // Need to change
        },
        {
          path: '/dashboard/statistic-report',
          title: 'Statistic Report',
          type: 'link',
          accessId: AccessList.View_User_Group // Need to change
        }
      ],
    }
  ];
  ...
  MEGAMENUITEMS: Menu[] = [
    ...
    },
    {
      ...
      children: [
        ...
        {
          path:
            'http://admin.pixelstrap.com/cuba/theme/ecommerce-templates.html',
          title: 'Ecommerce Email',
          type: 'extTabLink',
        },
        {
          path:
            'http://admin.pixelstrap.com/cuba/theme/email-order-success.html',
          title: 'Order Success',
          type: 'extTabLink',
        },
      ],
