...
@Component({
  selector: 'import-prize',
  templateUrl: './import-prize.component.html',
  styleUrls: ['./import-prize.component.scss'],
  providers: [NgbModalConfig, NgbModal, NgbActiveModal]
})
export class ImportPrizeMdl {
  @ViewChild('ImportPrizeMdl', { read: TemplateRef }) ImportPrizeModal: TemplateRef<any>;
  ...
  openModal(drawId) {
    ...
    this.modalReference = this.modalService.open(this.ImportPrizeModal, { size: 'xl', centered: true });
  }
  ...
  submit(data: NgForm) {
    ...
    this.slotService.ImportPrizePreview(request).pipe(takeUntil(this.destroy$)).subscribe((data: any) => {
