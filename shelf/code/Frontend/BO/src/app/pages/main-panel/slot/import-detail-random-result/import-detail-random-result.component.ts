...
@Component({
  selector: 'app-import-detail-random-result',
  templateUrl: './import-detail-random-result.component.html',
  styleUrls: ['./import-detail-random-result.component.scss']
})

export class ImportDetailRandomResultComponent {
